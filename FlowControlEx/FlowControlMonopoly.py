...
'''
Hi Mr. Burnham, this is one of the first projects I every worked on.
This was the program i discovered try and except blocks and used it 
to prevent any crashes in this monopoly score tracker.
'''
...
data = {}
with open("MonopolyV2.json", "r") as read_file:
